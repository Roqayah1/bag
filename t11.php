  ...
  <div class="container">
    ...
    <div class="control-group">
      ...
      <div class="control-group">
        ...
        <br>
    <label>
      <input placeholder="اسم التابع" class="input1" name="text" type="text" />
      <br><br>
      </label>
      <label>
          <input placeholder="رقم هاتف التابع" class="input2" name="text" type="tel" />
          <br><br>
      </label>
      <label>
     <input placeholder="رقم حقيبة التابع" class="input4" name="text" type="text"  />
     <br>
